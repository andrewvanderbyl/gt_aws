...
const columns: GridColDef[] = [
    { field: 'asa', headerAlign: 'center', align: 'center', headerClassName: 'super-app-theme--header', headerName: 'REGISTRATION NUMBER', width: 250, flex: 1 },
    { field: 'asaDate', headerAlign: 'center', align: 'center', headerClassName: 'super-app-theme--header', headerName: 'DATE', width: 150, flex: 1 },
  ];
